  ...
  return (
    <div>
      {isMobile ? (
        ...
        <div
          className={`${inter} w-[100%] h-[735.50px] bg-gradient-to-b from-[#FFA640] to-[#D27000] lg:w-full bg-orange-400 flex-col justify-start items-start inline-flex`}
        >
          ...
          <div className="self-stretch h-[607.50px] px-5 pt-28 pb-10 flex-col justify-start items-start gap-10 flex">
            ...
            <div className="w-[307px] h-[219px] relative">
              <Image
                className="absolute z-0 bottom-[-40px] right-[-50px]"
                width={200}
                height={200}
                src="/vector 2.svg"
                alt="site-logo"
              ...
              />
              <Image
                className="absolute h-min z-0 bottom-[-40px] right-[-50px]"
                width={100}
                height={200}
                src="/vector 3.svg"
                alt="site-logo"
        ...
        >
          ...
          <div className="self-stretch h-[500px] px-[180px] flex-row justify-center items-center inline-flex">
            <div className="grow shrink flex-col justify-center items-start inline-flex">
              ...
              <div className="h-[54px] px-6 bg-white rounded-[999px] justify-center items-center gap-3 inline-flex animate-fade-right animate-delay-900">
            ...
            <div className="flex-col  justify-center items-center inline-flex">
              <div className="w-[397.40px] z-10 h-[277.10px] relative animate-fade-up animate-delay-700">
