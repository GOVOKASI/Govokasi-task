...
export default function CompanyValues() {
  ...
  return (
    <section id="company-values" className="text-white bg-slate-100 p-6">
      {/* <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-slate-100 to-transparent rounded-full h-full w-full z-0 blur-xl absolute -top-1/4 left-4 transform -translate-y-1/2 -translate-1/2"></div> */}
      <div
        className="bg-gradient-to-tr from-slate-300 to-slate-100 w-full relative"
        style={{
          backgroundImage: `
          
          url(${FrameCompanyValues.src})`,
          backgroundSize: "1190px",
      ...
      >
        <div className="grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16">
          <motion.div
            className="text-black text-start mb-8 p-8"
            ref={ref}
              ...
              >
                <div className="p-6">
                  <div className="mb-2 flex justify-start items-center p-2 gap-5">
                    ...
                    <div className="text-gray-200 justify-center items-center text-start text-xl md:text-2xl font-bold leading-normal mb-2">
                      {value.title}
                    </div>
                  </div>
                  <div className="text-zinc-400 text-lg font-normal leading-tight">
                    {value.description}
                  </div>
                </div>
              </motion.div>
