    ...
    <div className="text-[#1A1D40] bg-[#E8E8EC] relative">
      <div className="bg-[#E8E8EC] py-20 relative z-10">
        <div className="flex justify-center flex-col items-center gap-5">
          <p className="text-sm leading-5">So What are you waiting for?</p>
          <h3 className="uppercase text-2xl leading-8 font-black text-center">
      ...
      <Image
        className="w-full object-cover lg:h-[463px]"
        src="/bg-footer.svg"
        alt="bg-footer"
        width={364}
        height={638}
      />
      <div className="flex lg:w-full lg:px-[140px] flex-col px-5 absolute bottom-0 py-10 gap-10 bg-gradient-to-b from-[#E8E8EC]/0 via-white to-white">
        <div className="flex justify-between gap-10">
          <div className=" flex flex-col lg:flex-row gap-5 lg:gap-7">
            <div className="text-sm leading-5 flex flex-col gap-1  lg:w-[290.67px] lg:text-xl lg:leading-6 lg:gap-3">
